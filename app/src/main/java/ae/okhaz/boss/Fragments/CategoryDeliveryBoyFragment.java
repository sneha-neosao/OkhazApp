...
public class CategoryDeliveryBoyFragment extends Fragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    String condition ="",  OrderID ="",  startDate ="",   endDate ="",deliveryMan="",
            branchID="",role="",name,pass,email,lat,lng,str;
    ...
    public static CategoryDeliveryBoyFragment newInstance(String name, int position,
                                                       int fromUpdate,String str,String id) {
        Bundle args = new Bundle();
        args.putString("code", name);
        args.putInt("position", position);
        args.putInt("fromUpdate", fromUpdate);
        args.putString("deliveryBoy", str);
        args.putString("id", id);
        CategoryDeliveryBoyFragment f = new CategoryDeliveryBoyFragment();
        f.setArguments(args);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_category_delivery_boy, container, false);
        ...
        fab_deli_boy_info = view.findViewById(R.id.fab_deli_boy_info);
        ...
        if(role.equals("Admin")|| role.equals("Supplier")){
            fab_deli_boy_info.setVisibility(View.VISIBLE);
        }
       ...
       // DeliveryBoyListActivity.toolbar.setTitle("Order List");
       // DeliveryBoyListActivity.toolbar.setNavigationIcon(R.drawable.ic_baseline_arrow_back_24);
        /*DeliveryBoyListActivity.toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DeliveryBoyListActivity.toolbar.setTitle("Delivery Boy List");
            }
        });*/
        ...
        fab_deli_boy_info.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getContext(), DeliveryBoyDetailsActivity.class)
...
//        }
    ...
    private void getOrdersData(String deliveryman, String BranchCode,
                               String OrderStatus, String offset, String condition, String OrderID,
    ...
    private void setRecycler(ArrayList<Order> orderArrayList)
    {
        ...
        orderAdapter = new AdminOrderAdapter1(orderArrayList, getContext(),pos,1);
...
//                    ((MainActivity)getActivity()).toolbar.setVisibility(View.VISIBLE);
    ...
    private void loadMore(final int scrollPosition, String deliveryman, String branchCode, String orderStatus, String condition, String orderID, String startDate, String endDate) {
        ...
        String date_range= DashboardFragment.date_range;
        ServiceGenerator.getDelivery().getOrders(deliveryman, branchCode, orderStatus, String.valueOf(scrollPosition),condition,orderID,startDate,endDate,date_range).enqueue(new Callback<ResponseOrderList>() {
            @Override
            public void onResponse(Call<ResponseOrderList> call, Response<ResponseOrderList> response) {
                if (response.isSuccessful())
                {
