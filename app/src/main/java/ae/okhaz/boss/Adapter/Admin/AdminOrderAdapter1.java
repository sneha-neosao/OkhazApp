...
import ae.okhaz.boss.Fragments.OrderDetailsFragment1;
 ...
 */
public class AdminOrderAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdminOrderAdapter1(ArrayList<Order> orderArrayList, Context context, int pos, int from) {
...
//                AdminOrderDetailFragment.order_qty_tv.setText(""+orderArrayList.get(position).getItemCount());

                /*Set main order number*/
                if(user.get(SessionManagement.KEY_USER_TYPE).toString().equals("Supplier")){
                    ...
                    holder.llDeviceName.setVisibility(View.GONE);
                }
                else {
                    holder.main_order_no_tv.setVisibility(View.GONE);
                    holder.llDeviceName.setVisibility(View.VISIBLE);
                    holder.tvDeviceName.setText(orderArrayList.get(position).getDeviceName().toUpperCase());
                }
                    ...
                    public void onClick(View view) {
                        ...
                        if (orderArrayList.get(position).getOrderStatus() == 1) {
                            updateOrderStatus(orderArrayList.get(position).getOrderID(),
                                ...
                                bundle.putString("qty", String.valueOf(order.getItemCount()));
                        ...
                        navController.navigate(R.id.goto_order_details_admin, bundle);*/
                            ...
                            if (from == 1) {
                                MainDrawerBackActivity activity = (MainDrawerBackActivity) view.getContext();
                                OrderDetailsFragment1 myFragment = new OrderDetailsFragment1();
                                myFragment.setArguments(bundle);
                                activity.getSupportFragmentManager().beginTransaction().replace(R.id.nav_supplier_fragment, myFragment).addToBackStack(null).commit();
                            } else {
                                MainDrawerBackActivity activity = (MainDrawerBackActivity) view.getContext();
